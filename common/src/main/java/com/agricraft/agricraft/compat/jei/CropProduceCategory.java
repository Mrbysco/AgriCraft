...
public class CropProduceCategory implements IRecipeCategory<AgriPlant> {
	...
	public static final ResourceLocation ID = AgriApi.modLocation("jei/produce");
	public static final RecipeType<AgriPlant> TYPE = new RecipeType<>(ID, AgriPlant.class);

	public static final IDrawable ICON = AgriCraftJeiPlugin.createDrawable(AgriApi.modLocation("textures/item/debugger.png"), 0, 0, 16, 16, 16, 16);
